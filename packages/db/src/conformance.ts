...
export type SchemaConformance = [
  ...
  Assert<Equal<CardRunRow, Wire<Omit<InferSelectModel<typeof cardRuns>, 'jobId'>>>>,
  Assert<Equal<AttachmentRow, Wire<InferSelectModel<typeof attachments>>>>,
  ...
  Assert<Equal<CardRunStatus, (typeof cardRunStatusEnum.enumValues)[number]>>,
