...
export default defineConfig({
  test: {
    ...
    // ENRICHMENT=off stops createIntakeItem from forking a background `claude -p`
    // that races assertions and hangs the suite (see spawnEnrichment).
    env: { EMBEDDING_MODEL: 'none', ENRICHMENT: 'off' },
